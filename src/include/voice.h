...
/// sample.)  Mezzo, at launch time, pre-allocate 128 voices that will
...
/// from a single sample to the Poly::mixer method in bundles of
...
/// has been instantiated (at program startup or when a new
...
class Voice : public NewHandlerSupport<Voice> {
 ...
 public:
  ...
  /// Called by the OpenSample Thread. The state of the
